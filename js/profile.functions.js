...
var profile = new function() {
	...
	this.check_password = function () {
			...
			if ($("#new_password").val()==$("#new_re_password").val()){
				...
				$.post("backend/ajax.get/member_check.php",{key:"crypted_password"  ,value: $("#password").val()},function(data){
					if(data!=""){
						$.post("backend/ajax.post/member_password_update.php",{crypted_password: $("#new_password").val()},function(data){
