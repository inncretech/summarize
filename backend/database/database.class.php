...
include "mysql.table.class/address.php";
include "mysql.table.class/school.php";
include "mysql.table.class/employer.php";
include "mysql.table.class/member_address.php";
include "mysql.table.class/member_school.php";
include "mysql.table.class/member_employer.php";
include "mysql.table.class/member_activity.php";
include "mysql.table.class/member_info.php";
include "mysql.table.class/member.php";
include "mysql.table.class/member_session.php";
include "mysql.table.class/reference_question.php";
include "mysql.table.class/report_product.php";
include "mysql.table.class/tag.php";
include "mysql.table.class/product.php";
include "mysql.table.class/product_info.php";
include "mysql.table.class/product_tag.php";
include "mysql.table.class/product_follow.php";
include "mysql.table.class/compare_products.php";
include "mysql.table.class/product_feedback.php";
include "mysql.table.class/questions.php";
include "mysql.table.class/answers.php";
include "mysql.table.class/comment_answers.php";
include "mysql.table.class/notifications.php";
include "mysql.table.class/view_details.php";
include "mysql.table.class/message.php";
include "mysql.table.class/point.php";
include "mysql.table.class/image_table.php";
include "mysql.table.class/product_image.php";
