...
$member_data			= $database->member->get($member_data['member_id']);		
...
$aux['seo_title']		= $member_data['seo_title'];
...
$database->member_activity->add($member_data['member_id'],"Answer",$data['answer_text'],$data['product_id'],$product_data['public_id'],$product_data['title']);
