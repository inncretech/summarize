	...
	<div class="thumbnail" style="background:white;width:200px;margin: 20px 0 0 0px;">
	  <label style="margin:0px;">
		<label class="image-holder" style="margin:0px;">
			<img src="<?='http://'.(S3_BUCKET).'.s3.amazonaws.com/m_'.$member_data['public_id']."_normal.jpg";?>" id="image-preview" data-src="holder.js/300x200" alt="300x200" style="max-width:none;">
		</label>
		<div id='preview'></div>
