<!--<div id="footer">
      <div class="container">
        <p class="muted credit">Copyright <a href="index.php">Summarize</a> 2012</p>
      </div>
    </div>
-->
<footer>
	...
	<script type="text/javascript" src="js/change.category.functions.js"></script>
	<script type="text/javascript" src="js/add.like.functions.js"></script>
	<script type="text/javascript" src="js/add.product.functions.js"></script>
	<script type="text/javascript" src="js/facebook.functions.js"></script>
	<script type="text/javascript" src="js/feedback.functions.js"></script>
	<script type="text/javascript" src="js/ajax.image.uploader.js"></script>
	<script type="text/javascript" src="js/jquery.form.js"></script>
	<script type="text/javascript" src="js/profile.functions.js"></script>
	<script type="text/javascript" src="js/follow.functions.js"></script>
	<script type="text/javascript" src="js/notification.functions.js"></script>
	<script type="text/javascript" src="js/message.functions.js"></script>
	<script type="text/javascript" src="js/crawler.functions.js"></script>
	...
	<script type="text/javascript" src="js/report.functions.js"></script>
</footer>