var message = new function() {
	...
	this.refreshSent = function (div) {
		$.post("backend/ajax.get/sent_messages.php",function(data){
	...
	this.refreshInbox = function (div) {
		$.post("backend/ajax.get/received_messages.php",function(data){
	...
	this.listen = function (trigger) {
		$(trigger).click(function(){
			$.post("backend/ajax.post/send_message.php",{subject: $("#subject").val(),body:$("#body").val(),to_member_name:$("#to_member_name").val()},function(data){
