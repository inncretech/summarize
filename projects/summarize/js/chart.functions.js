...
$("#chart-container").slideUp('slow',function(){$("#chart-container").parent().hide();});
var chartShow = false;
if (typeof product_id !== 'undefined') {
	$("#chart-toggle").click(function(){
		
		if (chartShow){
			$("#chart-toggle span").text("Show Chart");
			$("#chart-container").slideUp('slow',function(){$("#chart-container").parent().hide();});
			chartShow = false;
		}else{
			$("#chart-toggle span").text("Hide Chart");
			chartShow = true;
			$("#chart-container").parent().show();
			$("#chart-container").slideDown('slow');
		}
	});
}
