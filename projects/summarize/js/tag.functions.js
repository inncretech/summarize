var tag = new function() {
		...
		this.save = function (tag_name,product_id) {
				...
				$.post("backend/ajax.post/add_tag.php",{tag_name:tag_name,product_id:product_id},function(data){
		...
		this.remove = function (tag_name,product_id) {
				...
				$.post("backend/ajax.post/remove_tag.php",{tag_name:tag_name,product_id:product_id},function(data){
